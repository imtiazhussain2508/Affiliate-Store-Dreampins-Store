...
### Admin Panel
- ✅ Simple admin login (username: webdream1, password: dreammarket213)
- ✅ Add new products with title, description, price (USD & PKR), image URL, and affiliate link
...
- ✅ Show product image, title, price (USD and PKR), description
